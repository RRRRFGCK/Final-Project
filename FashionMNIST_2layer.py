...
path_name = f'output_img/seed={seed}/Fashion_2layer/{kernel_init_type}/'
import os
...
def visualize_filter_bank(W, filename):
    ...
    grid = torchvision.utils.make_grid(W, normalize=True, nrow=15)  # [C, H_grid, W_grid]
...
import csv
# 保存数据到CSV文件
if not os.path.exists(f"plot_data/seed={seed}/Fashion_2layer/"):
    os.makedirs(f"plot_data/seed={seed}/Fashion_2layer/", exist_ok=True)
csv_filename = f'plot_data/seed={seed}/Fashion_2layer/{kernel_init_type}.csv'

...
target_size = 28
batch_size  = 64
conv1_k = 14   # conv1 kernel size  → output spatial: (28-14)/7+1 = 3
conv1_s = 7    # conv1 stride
conv2_k = 3    # conv2 kernel size  → matches the 3x3 feature map exactly

path_name = f'output_img/seed={seed}/Fashion_2layer_FMinit/{kernel_init_type}/'
...
# ============================================================
net = Net().to(device)
tbwriter = SummaryWriter(f'logs/Fashion_2layer_FMinit_{kernel_init_type}_seed{seed}')
...
# Save CSV
# ============================================================
csv_dir = f'plot_data/seed={seed}/Fashion_2layer_FMinit/'
